...
<body>
    <div class="dashboard">
                ...
                <div class="navbar-menu-links">
                    ...
                    <div class="menuDropDown">
                        ...
                        <div class="menuDrop-links">
                            ...
                            <a href="permissions.html" class="menuDrop-link active">Permissions</a>
                        </div>
                    </div>
        ...
        <div class="dashboard-body">
            ...
            <a href="permissions.html" class="goBack">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="addNewPermission-container">
                <h2>Permissions məlumatı</h2>
                <form action="" class="addNewPermissionForm" method="post">
                    <div class="form-items">
                        ...
                        <div class="form-item">
                            ...
                            <input type="text" placeholder="Qrup adı">
                        </div>
                    </div>
