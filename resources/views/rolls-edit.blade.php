...
<body>
    <div class="dashboard">
                ...
                <div class="navbar-menu-links">
                    ...
                    <div class="menuDropDown">
                        ...
                        <div class="menuDrop-links">
                            <a href="users.html" class="menuDrop-link">İstifadəçilər</a>
                            <a href="rolls.html" class="menuDrop-link active">Rollar</a>
        ...
        <div class="dashboard-body">
            ...
            <a href="rolls.html" class="goBack">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="addNewRolls-container">
                <h2>Roll məlumatı</h2>
                <form action="" class="addNewRollsForm" method="post">
                        ...
                        <div class="rolls-checks-box">
                            ...
                            <div class="rolls-checks-list">
                                <div class="rolls-check-item">
                                    <input type="checkbox">
                                    <label for="">Redaktə</label>
                                </div>
                                <div class="rolls-check-item">
                                    <input type="checkbox">
                                    <label for="">Yaratmaq</label>
                                </div>
                                <div class="rolls-check-item">
                                    <input type="checkbox">
                                    <label for="">Redaktə etmək</label>
                                </div>
                                <div class="rolls-check-item">
                                    <input type="checkbox">
                                    <label for="">Hamısı</label>
                                </div>
