...
@section('content')
        ...
        <div class="table-universityList-container">
            <table>
                ...
                <tr>
                    ...
                    <th class="universityListName">Şəhər</th>
                ...
                @foreach($towns as $key => $town)
                    <tr>
                        ...
                        <td class="universityListName">{{$town->title}}</td>
                        <td class="universityListOthersButtons">
                            <button class="universityListEdit" onclick="openEditModal({{ $town }})">
    ...
    <x-pagination :paginator="$towns"/>
    <div class="addUniversity-Modal">
        <div class="addUniversity-Modal-box">
            <div class="addUniversity-Modal-box-head">
                <h2>Şəhər əlavə et</h2>
                <button class="closeAddUniversity-Modal" type="button">
                    <img src="{{asset('/')}}assets/images/x.svg" alt="">
                </button>
            </div>
            <form action="{{ route('towns.store') }}" class="form_addUniversity-Modal" method="POST">
                @csrf
                <div class="form-item">
                    <label for="">Şəhər adı</label>
                    <input type="text" name="title" placeholder="Şəhər">
                </div>
    ...
    <div class="editUniversity-Modal">
        <div class="editUniversity-Modal-box">
            ...
            <form id="editForm" method="POST" class="form_editUniversity-Modal">
                ...
                @method('PUT')
                <div class="form-item">
                    <label for="">Şəhər adı<sup>*</sup></label>
                    <input type="text" id="editTitle" name="title" placeholder="Şəhər">
                </div>
    ...
    <script>
        ...
        function openEditModal(town) {
            document.getElementById('editTitle').value = town.title;
            document.getElementById('editForm').action = `/towns/${town.id}`;
