...
<body>
    <div class="dashboard">
        ...
        <div class="dashboard-body">
            ...
            <a href="permission-add.html" class="addNewPermission">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="table-permission-container">
                <table>
                  <thead>
                    <tr>
                      <th class="permissionNumber">№</th>
                      <th class="permissionName">Ad</th>
                      <th class="permissionGroup">Qrup</th>
                      <th class="permissionOthers">Digər</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      <td class="permissionNumber">1</td>
                      <td class="permissionName">Redaktə etmək</td>
                      <td class="permissionGroup">Rollar</td>
                      <td class="permissionOthersButtons">
                        <a href="permission-edit.html" class="permissionEdit">
