...
class SettingDocumentController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $document = SettingDocument::create([
            'title' => $request->title,
        ]);

        $document->educationLevels()->sync($request->education_level_ids);
     ...
     */
    public function show(SettingDocument $setting_document): void {}
    ...
    public function update(Request $request, SettingDocument $setting_document)
    {
        ...
        $setting_document->educationLevels()->sync($request->education_level_ids);
