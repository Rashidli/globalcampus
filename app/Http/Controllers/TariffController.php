...
//        dd($request->all());
        ...
        return view('tariffs.index', compact(
            'tariffs', 'education_levels',
            'towns', 'professions', 'education_languages', 'count',
            'school_types','university_lists','countries','currencies'
        ));
    }
    ...
    private function applyFilters(Request $request)
    {
        return Tariff::query()
            ...
            ->when($request->filled(['min_price', 'max_price']), function ($q) use ($request) {
...
//    }
    ...
    public function create()
    {
        ...
        return view('tariffs.create', compact(
            'education_languages','towns','education_levels',
            'professions','university_lists','countries','currencies','education_costs'
        ));
    ...
    public function edit(Tariff $tariff)
    {
        ...
        return view('tariffs.edit', compact(
            'tariff','education_languages','education_levels',
            'towns','professions','university_lists','countries','currencies'
        ));
    }
    ...
    public function allEdit($university_id)
    {
        ...
        return view('tariffs.all_edit', compact(
            'tariffs','currencies','university','professions'
        ));
