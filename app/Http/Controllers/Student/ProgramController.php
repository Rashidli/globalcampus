...
class ProgramController extends Controller
{
    ...
    public function create($student_id)
    {
        ...
        return view('students.programs.create', compact(
            'countries', 'periods',
            'education_levels', 'university_lists',
            'tariffs', 'program_statuses', 'user'
        ));
    }
    ...
    public function store(Request $request, $student_id)
    {
        ...
        return redirect()->route('programs.index', $user->id)->with('message', 'Program uğurla əlavə olundu');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->back()->with('message' , 'Program uğurla yeniləndi.');
    }
